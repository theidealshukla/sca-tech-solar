...
export default function SubsidyBanner() {
  return (
    <section className="py-16 md:py-20 bg-solar-500 relative overflow-hidden">
      {/* Decorative circles */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-solar-600/50 rounded-full -translate-x-1/2 translate-y-1/2 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-white text-xs font-bold tracking-widest uppercase">PM Surya Ghar Scheme · 2024</span>
            </div>
            ...
            <p className="text-solar-100 text-base md:text-lg leading-relaxed mb-8">
            ...
            <Link to="/contact" className="inline-flex items-center gap-2 bg-white text-solar-700 px-7 py-3.5 rounded-full font-bold text-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-7 border border-white/20">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center">
                  <IndianRupee className="w-6 h-6 text-solar-500" />
                </div>
                <div>
                  <p className="text-white font-black text-2xl">₹78,000+</p>
                  <p className="text-solar-200 text-sm">Maximum subsidy available</p>
                </div>
              </div>
              <div className="grid grid-cols-1 gap-3">
                {benefits.map((benefit, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 text-solar-200 flex-shrink-0 mt-0.5" />
